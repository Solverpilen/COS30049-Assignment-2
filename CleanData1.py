...
DataRaw = pd.read_csv(RawDataDirectory + "MELBOURNE_HOUSE_PRICES_LESS_acedit.csv", 
                    dtype={
                        "Suburb": "string",
                        "Address": "string",
                        "Rooms": "Int32",
...
DataRaw = DataRaw.drop(columns=["Address", "Method", "SellerG", "CouncilArea", "BuildingArea", "YearBuilt", "Regionname", "Propertycount"])
